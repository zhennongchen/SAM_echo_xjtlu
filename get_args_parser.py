...
def get_args_parser(img_size = 128, num_classes = 2, augment_frequency = 0.5, pretrained_model = None, original_sam = None, start_epoch = None, total_training_epochs = 1000, vit_type = "vit_h"):
    ...
    parser.add_argument('--augment_frequency', default=augment_frequency, type=float)
