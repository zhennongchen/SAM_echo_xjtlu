...
def train_loop(model: torch.nn.Module,
    ...
    for data_iter_step, batch in enumerate(tqdm(data_loader_train)):
        with torch.cuda.amp.autocast():
            ...
            # print('output mask shape', output["masks"].shape, ' mask shape', mask.shape)
            ...
            loss_scaler(loss, optimizer, parameters=subset_params, update_grad=(data_iter_step + 1) % accum_iter == 0)  
